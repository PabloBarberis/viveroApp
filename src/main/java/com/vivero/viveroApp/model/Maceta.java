...
public class Maceta extends Producto {
    ...
    @Enumerated(EnumType.STRING) // Almacena el nombre del enum como un String en la base de datos
    @Column(name = "modelo_maceta")
    private ModeloMaceta modelo; // Modelo de la maceta

    // Constructor personalizado para inicializar atributos
    public Maceta(ColorMaceta color, MaterialMaceta material, String tamaño, ModeloMaceta modelo, Long id, String nombre, String marca, Double precio, Integer stock, String descripcion, boolean activo, List<Proveedor> proveedores) {
