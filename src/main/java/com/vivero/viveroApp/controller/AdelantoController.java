...
public class AdelantoController {
    ...
    @Autowired
    public AdelantoController(AdelantoService adelantoService, UsuarioService usuarioService, RegistroHorarioService registroHorarioService,
            GastoService gastoService) {
        this.adelantoService = adelantoService;
    ...
    public Map<String, Object> obtenerTotales(@RequestParam("usuarioId") Long usuarioId, @RequestParam("mes") int mes, @RequestParam("año") int año) {
        ...
        double totalNeto = totalGanado - totalGastos - totalAdelantos;
