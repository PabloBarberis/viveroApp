...
import com.vivero.viveroApp.model.enums.ModeloMaceta;
...
public class MacetaController {
    ...
    public String listarMacetas(@RequestParam(defaultValue = "0") int page,
                                ...
                                @RequestParam(required = false) ModeloMaceta modelo,
                                @RequestParam(required = false) MaterialMaceta material,
                                Model model) {
        String colorStr = color != null ? color.name() : null;
        String modeloStr = modelo != null ? modelo.name() : null;
        String materialStr = material != null ? material.name() : null;
        Page<Maceta> macetaPage = macetaService.buscarMacetaPaginado(nombre, colorStr, marca, modeloStr, materialStr, page, size);
        ...
        model.addAttribute("modelos", ModeloMaceta.values());
        model.addAttribute("materiales", MaterialMaceta.values());
        model.addAttribute("selectedColor", color);
        model.addAttribute("selectedModelo", modelo);
    ...
    public String mostrarFormularioCrear(Model model) {
        ...
        model.addAttribute("modelosMaceta", ModeloMaceta.values());
